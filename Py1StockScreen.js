...
import Py1SaleScreen, { totalSale } from '../screens/Py1SaleScreen';


const Py1StockScreen = () => {
    ...
    const [totalStock, setTotal7] = useState('')
    ...
    const addThemAllTogether = () => setTotal7(totalB + totalA + total8 + total5)
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <Text style={styles.buttonTextGas}>ใส่ 5kgSTOCK</Text>
            ...
            <TouchableOpacity
                ...
                style={styles.buttonGas}
            >
                <Text style={styles.buttonTextGas}>ใส่ 7KgSTOCK</Text>
            ...
            <TouchableOpacity
                ...
                style={styles.buttonGas}
            >
                <Text style={styles.buttonTextGas}>ใส่ 15KgSTOCK</Text>
            ...
            <TouchableOpacity
                ...
                style={styles.buttonGas}
            >
                <Text style={styles.buttonTextGas}>ใส่ 24Kg ถังSTOCK</Text>
            ...
            <View style={styles.InputcontainerGas}>
                <Text> นำ้แก๊ส TotalStock :  {totalStock}  KG</Text>
            ...
            <TouchableOpacity
                ...
                style={styles.buttonGas}
            >
                <Text style={styles.buttonTextGas}>addSaleStockTogether</Text>
